...
# Directory with with mask images
With_Mask = os.path.join(r'E:\ML Project\dataset\with mask')

# Directory with without mask images
...
model = tf.keras.models.Sequential([
    # Note the input shape is the desired size of the image 200*200 with 3 bytes color
